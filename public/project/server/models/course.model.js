...
module.exports = function(db, mongoose) {
    ...
    function updateAssignment(courseId, moduleId, assignmentId, assignment) {
        ...
        getCourseById(courseId).then(function(course) {
            var asgn = course.modules.id(moduleId).assignments.id(assignmentId);
            asgn.title = assignment.title;
            asgn.src = assignment.src;
    ...
    function updateDependency(courseId, moduleId, exampleId, demoId, dependencyId, dependency) {
        ...
        getCourseById(courseId).then(function(course){
            var dep = course.modules.id(moduleId).examples.id(exampleId).demos.id(demoId).dependencies.id(dependencyId);

            dep.title = dependency.title;
